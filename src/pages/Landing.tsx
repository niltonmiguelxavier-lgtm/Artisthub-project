    ...
    <>
                ...
                return (
                  <div key={ind.id}>
                    <div className="mb-1.5 flex justify-between text-xs text-bone-300">
                      <span>{ind.label}</span>
                      <span className="font-mono-data text-cobalt-400">{ind.value}%</span>
                    </div>
      ...
      <section className="border-t border-ink-800 bg-ink-900/40 px-5 py-16 lg:py-24">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-12 rounded-2xl border border-cobalt-500/30 bg-cobalt-500/5 p-8 text-center">
            <p className="font-display text-2xl text-cobalt-400 sm:text-3xl">
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
            {pillars.map(({ icon: Icon, label, description }) => (
              <div key={label} className="rounded-2xl border border-ink-800 bg-ink-900 p-5">
                <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-ink-800 text-cobalt-400">
