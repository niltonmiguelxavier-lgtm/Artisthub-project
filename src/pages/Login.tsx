    ...
    <div className="flex min-h-[85vh] items-center justify-center px-4 py-12">
      <div className="w-full max-w-md rounded-2xl border border-ink-800 bg-ink-900/90 p-8 shadow-2xl backdrop-blur-xl">
        <div className="mb-6 text-center">
          ...
          <h1 className="font-display text-2xl text-bone-100">Bem-vindo ao ArtistHub</h1>
          <p className="mt-1 text-sm text-bone-400">Entra na tua conta para gerir a tua carreira musical</p>
        </div>
        ...
        >
          ...
          {googleLoading ? 'A conectar ao Google...' : 'Continuar com o Google'}
        </button>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <div className="mb-1.5 flex items-center justify-between">
              <label className="text-xs font-medium text-bone-300">Palavra-passe</label>
              <Link
                to="/forgot-password"
                className="text-xs text-cobalt-400 hover:text-cobalt-300 hover:underline"
              >
                Esqueceste-te?
              </Link>
            </div>
        ...
        <div className="mt-6 text-center text-xs text-bone-400">
          ...
          <Link to="/register" className="font-medium text-cobalt-400 hover:underline">
