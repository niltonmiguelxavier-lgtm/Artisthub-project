  ...
  return (
    <aside className="hidden w-64 shrink-0 flex-col border-r border-ink-800 bg-ink-900 lg:flex">
      ...
      <div className="border-t border-ink-800 px-3 py-4">
        <NavLink
          to={`/artist/${currentArtist.handle}`}
          className="flex items-center justify-between rounded-xl border border-ink-700 px-3 py-2.5 text-sm text-bone-300 hover:border-brass-500 hover:text-brass-400"
        >
